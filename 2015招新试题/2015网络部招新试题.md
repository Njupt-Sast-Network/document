...
print rec(12450)
```
#####4.你是否在网页中总能碰到这样一种动画效果，当鼠标悬停在某一行字上时，这些字的样式会发生一些改变，这些都可以通过代码来实现，不如我们来做个简单的实验~
-----------
 >       <!DOCTYPE html>
    <html>
    <head>
...
上面是一段最简单的html代码，通过百度好好研究下如何当鼠标移到“欢迎来到校科协网络部”这几个字的时候，这些字的大小和颜色进行改变，度娘是万能的，相信你一定能找到多种方法，请写下来，多方法可以有适当加分哟~
##四、网络安全
